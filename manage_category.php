<?php include("includes/header.php");
  ...
  { 
    ...
    $qry_wallpaper1="SELECT COUNT(*) as num FROM tbl_channels WHERE cat_id='".$cat_id."'";
    $total_wallpaper1 = mysqli_fetch_array(mysqli_query($mysqli,$qry_wallpaper1));
    $total_wallpaper1 = $total_wallpaper1['num'];

    $qry_wallpaper2="SELECT COUNT(*) as num FROM tbl_highlight WHERE cat_id='".$cat_id."'";
    $total_wallpaper2 = mysqli_fetch_array(mysqli_query($mysqli,$qry_wallpaper2));
    $total_wallpaper2 = $total_wallpaper2['num'];

    $qry_wallpaper3="SELECT COUNT(*) as num FROM tbl_TV WHERE cat_id='".$cat_id."'";
    $total_wallpaper3 = mysqli_fetch_array(mysqli_query($mysqli,$qry_wallpaper3));
    $total_wallpaper3 = $total_wallpaper3['num'];
     
    $qry_wallpaper4="SELECT COUNT(*) as num FROM tbl_video WHERE cat_id='".$cat_id."'";
    $total_wallpaper4 = mysqli_fetch_array(mysqli_query($mysqli,$qry_wallpaper4));
    $total_wallpaper4 = $total_wallpaper4['num'];
    
    return $total_wallpaper1+ $total_wallpaper2+ $total_wallpaper3+ $total_wallpaper4;
