<?php error_reporting(0);
    ...
    session_start();
 	...
 	header("Content-Type: text/html;charset=UTF-8");
		...
		if($_SERVER['HTTP_HOST']=="localhost" or $_SERVER['HTTP_HOST']=="139.162.55.169")
		{	
			//local  
				 ...
				 DEFINE ('DB_NAME', 'viavio7b_live_tv_app_demo');
		}
		else
		{
			//local live 
 			 ...
 			 DEFINE ('DB_USER', 'root');
			 DEFINE ('DB_PASSWORD', 'lumaw123');
			 DEFINE ('DB_HOST', 'localhost');           //host name depends on server
			 DEFINE ('DB_NAME', 'gc_db');
		}
