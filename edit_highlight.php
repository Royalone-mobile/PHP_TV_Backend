<?php include("includes/header.php");
	...
	{
		$viv_qry="SELECT * FROM  tbl_highlight WHERE id='".$_GET['channel_id']."'";
	...
	if(isset($_POST['submit']) and isset($_GET['channel_id']))
	{
		...
		$channel_edit=Update('tbl_highlight', $data, "WHERE id = '".$_POST['channel_id']."'"); 

		$_SESSION['msg']="11"; 
		header( "Location:edit_highlight.php?channel_id=".$_POST['channel_id']);
		exit;
        ...
        <div class="card">
          <div class="page_title_block">
            <div class="col-md-5 col-xs-12">
              <div class="page_title">Edit Highlight</div>
            </div>
          </div>
