...
$qry_highlight="SELECT COUNT(*) as num FROM tbl_highlight";
$total_highlight = mysqli_fetch_array(mysqli_query($mysqli,$qry_highlight));
$total_highlight = $total_highlight['num'];

$qry_TV="SELECT COUNT(*) as num FROM tbl_TV";
$total_TV = mysqli_fetch_array(mysqli_query($mysqli,$qry_TV));
...
?>       
    ...
    <div class="row">
      ...
      <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12"> <a href="manage_highlight.php" class="card card-banner card-aliceblue-light">
        <div class="card-body"> <i class="icon fa fa-twitter fa-4x"></i>
          <div class="content">
            <div class="title">Highlight</div>
            <div class="value"><span class="sign"></span><?php echo $total_highlight;?></div>
          </div>
        </div>
        </a> </div>
      <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12"> <a href="manage_TV.php" class="card card-banner card-skyeblue-light">
        <div class="card-body"> <i class="icon fa fa-heart fa-4x"></i>
          <div class="content">
            <div class="title">TV</div>
            <div class="value"><span class="sign"></span><?php echo $total_TV;?></div>
          </div>
        </div>
        </a> </div>
