<?php include("includes/header.php");
	...
	{
		$viv_qry="SELECT * FROM  tbl_video WHERE id='".$_GET['channel_id']."'";
	...
	if(isset($_POST['submit']) and isset($_GET['channel_id']))
	{
		...
		$channel_edit=Update('tbl_video', $data, "WHERE id = '".$_POST['channel_id']."'"); 

		$_SESSION['msg']="11"; 
		header( "Location:edit_video.php?channel_id=".$_POST['channel_id']);
		exit;
