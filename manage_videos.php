...
if(isset($_POST["search"]))
{
  ...
  $qry="SELECT * FROM tbl_video,tbl_category WHERE cat_id=cid and channel_title LIKE '%".$channel_name."%' ORDER BY tbl_video.id DESC"; 
}
else
{ 
  ...
  $qry="SELECT tbl_video.*,tbl_category.category_name FROM tbl_video
LEFT JOIN tbl_category ON tbl_video.cat_id= tbl_category.cid ORDER BY tbl_video.id DESC LIMIT $start, $limit";	  
}
	$result=mysqli_query($mysqli,$qry);
if(isset($_GET['channel_id']))
{
	$img_res=mysqli_query($mysqli,'SELECT * FROM tbl_video WHERE id=\''.$_GET['channel_id'].'\'');
	...
	Delete('tbl_video','id='.$_GET['channel_id'].'');
...
if(isset($_GET['slider_deactive_id']))
{
  ...
  $edit_status=Update('tbl_video', $data, "WHERE id = '".$_GET['slider_deactive_id']."'");
...
if(isset($_GET['slider_active_id']))
{
  ...
  $edit_status=Update('tbl_video', $data, "WHERE id = '".$_GET['slider_active_id']."'");
        ...
        <div class="card mrg_bottom">
          <div class="page_title_block">
            <div class="col-md-5 col-xs-12">
              <div class="page_title">Manage Video</div>
            </div>
            <div class="col-md-7 col-xs-12">              
                  <div class="search_list">
                    ...
                    <div class="add_btn_primary"> <a href="add_video.php?add=yes">Add Video</a> </div>
                  </div>
                ...
                <div class="block_wallpaper">
                  ...
                  <div class="wall_image_title">
                    ...
                    <ul>
                      ...
                      <li>
                        <?php if($row['slider_channel']!="0"){?>
                         <a href="manage_videos.php?slider_deactive_id=<?php echo $row['id'];?>" data-toggle="tooltip" data-tooltip="Slider"><div style="color:green;"><i class="fa fa-sliders"></i></div></a> 
                      <?php }else{?>
                         <a href="manage_videos.php?slider_active_id=<?php echo $row['id'];?>" data-toggle="tooltip" data-tooltip="Set Slider"><i class="fa fa-sliders"></i></a> 
                      <?php }?>
                      </li>

                      <?php if($row['featured_channel']!="0"){?>
                        <li><a href="manage_videos.php?featured_deactive_id=<?php echo $row['id'];?>" data-toggle="tooltip" data-tooltip="Featured"><div style="color:green;"><i class="fa fa-circle"></i></div></a></li>
                      <?php }else{?>
                        <li><a href="manage_videos.php?featured_active_id=<?php echo $row['id'];?>" data-toggle="tooltip" data-tooltip="Set Featured"><i class="fa fa-circle"></i></a></li>
                      <?php }?> 
                    ...
                    <ul>
                      ...
                      <li><a href="edit_video.php?channel_id=<?php echo $row['id'];?>" data-toggle="tooltip" data-tooltip="Edit"><i class="fa fa-edit"></i></a></li>
